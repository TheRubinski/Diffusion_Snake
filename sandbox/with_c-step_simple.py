...
C=Spline((generate_points_in_circle(spline_points)*size/3+size/2), k=k)
...
def animate(frame):
    ...
    # print(B_Bold.shape)                                         # (spline_points, s_points)
    ...
    # XXX NEXT: über die k+1 ersten Punkte in C.points doppelt drüber gehen !
            # since: B_Bold.shape = (20, 12) = (i, m+k)
